...
export default function UserDropdown() {
  ...
  const avatar = employee?.avatarUrl || "/images/user/default-avatar.png";
  const name = employee?.name || user?.username || "Unknown User";
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <button
          onClick={handleSignOut} // <-- click để logout
