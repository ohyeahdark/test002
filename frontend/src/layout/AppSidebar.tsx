...
const navItems: NavItem[] = [
  ...
  {
    icon: <UserCircleIcon />,
    name: t('sidebar.user_profile'),
    path: "/profile",
  },
  {
    name: t('sidebar.forms'),
    icon: <ListIcon />,
    subItems: [{ name: t('sidebar.form_elements'), path: "/form-elements", pro: false }],
  },
  {
    name: t('sidebar.tables'),
    icon: <TableIcon />,
    subItems: [{ name: t('sidebar.basic_tables'), path: "/basic-tables", pro: false }],
  },
  {
    name: t('sidebar.pages'),
    icon: <PageIcon />,
    subItems: [
      { name: t('sidebar.blank_page'), path: "/blank", pro: false },
      { name: t('sidebar.error_404'), path: "/error-404", pro: false },
    ],
  },
];
...
const othersItems: NavItem[] = [
  {
    ...
    subItems: [
      { name: t('sidebar.line_chart'), path: "/line-chart", pro: false },
      { name: t('sidebar.bar_chart'), path: "/bar-chart", pro: false },
    ],
  },
  {
    icon: <BoxCubeIcon />,
    name: t('sidebar.ui_elements'),
    subItems: [
  ...
  },
  {
    ...
    subItems: [
      { name: t('sidebar.sign_in'), path: "/signin", pro: false },
      { name: t('sidebar.sign_up'), path: "/signup", pro: false },
    ],
  },
];
